          ...
          child: SingleChildScrollView(
              child: Padding(
                  ...
                  child: Column(children: [
                    ...
                    TextNum(
                        mainText:
                            'Что боялся в этом момент $situationR сделать? Что запрещал себе там делать, а хотел?',
                        numText: '1. Возвращаемся в психотравму и спрашиваем '),
                    TextNum(
                        mainText:
                    ...
                    TextNum(
                        mainText:
                            'Хорошо. Теперь мысленно со всеми изменения, новыми вывода и решениями растешь до настоящего возраста сегодняшнего дня, как дорастешь скажешь мне об этом.',
                        numText: '8. '),
                    SizedBox(
                      height: 50,
                    ),
